...
def get_columns() -> list:
    return [
        column.name
        for column in License_plate._meta.get_fields()
        if column.name != "id"
    ]
